...
export class TodaysAttendanceComponent implements OnInit, OnDestroy {
  ...
  selection = new SelectionModel<TodaysAttendance>(true, []);
  ...
  deleteItem(row: TodaysAttendance) {
  ...
  onContextMenu(event: MouseEvent, item: TodaysAttendance) {
