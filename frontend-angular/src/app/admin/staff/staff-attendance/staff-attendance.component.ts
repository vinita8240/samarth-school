...
export class StaffAttendanceComponent implements OnInit, OnDestroy {
  ...
  deleteItem(row: StaffAttendance) {
  ...
  exportExcel() {
    const exportData = this.dataSource.filteredData.map((x) => ({
      ...
      'Total Hours': x.total,
      Shift: x.shift,
      'Late Arrival': x.late_arrival,
      'Early Departure': x.early_departure,
      'Absence Reason': x.absence_reason,
      Overtime: x.overtime,
      'Total Breaks': x.total_breaks,
      Remarks: x.remarks,
      'Attendance Status': x.attendance_status,
  ...
  onContextMenu(event: MouseEvent, item: StaffAttendance) {
